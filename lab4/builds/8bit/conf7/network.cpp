...
#pragma HLS array_partition variable=xbuf cyclic factor=2 dim=1		// same factor as unroll maybe?
#pragma HLS array_partition variable=layer_1_out cyclic factor=2 dim=1
