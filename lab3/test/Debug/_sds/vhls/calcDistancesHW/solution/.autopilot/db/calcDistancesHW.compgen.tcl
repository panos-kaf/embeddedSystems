...
set ID 4
set MemName calcDistancesHW_dbkb
...
# Memory (RAM/ROM)  definition:
set ID 5
set MemName calcDistancesHW_mcud
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 32
set AddrRange 32
...
# Memory (RAM/ROM)  definition:
set ID 6
set MemName calcDistancesHW_ddEe
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 32
set AddrRange 1024
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_data_hw \
    op interface \
    ports { data_hw_dout { I 32 vector } data_hw_empty_n { I 1 bit } data_hw_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 0 \
    sync_rst true \
    corename dc_dists_hw \
    op interface \
    ports { dists_hw_din { O 32 vector } dists_hw_full_n { I 1 bit } dists_hw_write { O 1 bit } } \
} "
}
