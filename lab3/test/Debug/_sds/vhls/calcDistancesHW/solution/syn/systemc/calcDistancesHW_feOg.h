...
#ifndef __calcDistancesHW_feOg__HH__
#define __calcDistancesHW_feOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(calcDistancesHW_feOg) {
    ...
    SC_CTOR(calcDistancesHW_feOg):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
