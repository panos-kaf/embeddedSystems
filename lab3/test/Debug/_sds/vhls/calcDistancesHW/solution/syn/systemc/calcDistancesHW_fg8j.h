...
#ifndef __calcDistancesHW_fg8j__HH__
#define __calcDistancesHW_fg8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(calcDistancesHW_fg8j) {
    ...
    SC_CTOR(calcDistancesHW_fg8j):  ACMP_fsqrt_U ("ACMP_fsqrt_U") {
