...
{
    QITEM *newNode = malloc(sizeof(QITEM));
    if (!newNode) {
    ...
    cdslq->enqueue(0, cdslq, (void*) newNode);
    g_qCount++;
}

void dequeue (int *piNode, int *piDist, int *piPrev)
{
    QITEM* qKill = (QITEM*) cdslq->dequeue(0, cdslq);
